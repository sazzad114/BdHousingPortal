                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="error"><c:if test="${flat.forRent == true}"><form:errors path="priceOrRent"/></c:if></span>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="error"><c:if test="${flat.forRent == false}"><form:errors path="priceOrRent"/></c:if></span>
                            </td>
                        </tr>
